...
async def list_notifications(
    ...
    """List notifications for the authenticated user. Returns unread_count in meta."""
...
async def mark_all_notifications_as_read(
    ...
    user_id = await resolve_current_user_id(db, context.user_id)
    service = NotificationService(db)
    marked_count = await service.mark_all_as_read(str(user_id), company_id)
...
async def create_notification(
    ...
    """Create a new notification/announcement. Requires company_admin."""
    company_id = _require_company_id(context)
...
async def list_notifications_admin(
    ...
    """Admin view: list all notifications for management. Requires company_admin."""
    company_id = _require_company_id(context)
...
async def deactivate_notification(
    ...
    """Deactivate a notification (soft-delete). Requires company_admin."""
    company_id = _require_company_id(context)
